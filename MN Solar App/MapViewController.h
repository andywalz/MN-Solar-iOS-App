...
@property (nonatomic, weak) NSString *layerEUSAStatus;
@property (nonatomic, weak) NSString *layerSolarInstallsStatus;
@property (nonatomic, weak) NSString *layerTilesStatus;
