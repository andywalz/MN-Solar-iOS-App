...
-(void)copyDatabaseIntoDocumentsDirectory{
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:destinationPath]){
        ...
        // Check if any error occurred during the copying and display it.
        if (error !=nil){
...
-(void)runQuery:(const char *)query isQueryExecutable:(BOOL)queryExecutable{
    ...
    if (openDatabaseResult == SQLITE_OK){
        ...
        BOOL prepareStatementResult = sqlite3_prepare16_v2(sqlite3Database, query, -1, &compiledStatement, NULL);
...
-(void)executeQuery:(NSString *)query{
    // Run the query and indicate that is executabe.
